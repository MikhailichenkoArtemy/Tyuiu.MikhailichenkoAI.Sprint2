...
namespace Tyuiu.MikhailichenkoAI.Sprint2.Task4.V11
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.Title = "Спринт #2 | Выполнил: Михайличенко А. И. | ИИПБ2-1";
            Console.WriteLine("***************************************************************************");
            ...
            Console.WriteLine("* переменных x, y с клавиатуры. Округлить до 3 знаков после запятой.      *");
            Console.WriteLine("***************************************************************************");
